...
// Gera números aleatórios, maiores no modo desafio function gerarNumeros (modo) {
...
// Calcula o resultado com base nos números e operação function calcularResposta (n1, n2, op) {
...
function verificarResposta() {
    ...
    document.getElementById("resultado").innerText = 'X Errado! A resposta era $(respostaCorreta}';
